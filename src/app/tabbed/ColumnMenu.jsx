...
import { GridColumnMenuFilter, GridColumnMenuSort, GridColumnMenuItem, GridColumnMenuColumnsList, GridColumnMenuItemGroup, GridColumnMenuGroup } from '@progress/kendo-react-grid';
import { TabStrip, TabStripTab } from '@progress/kendo-react-layout';
import { filterIcon, slidersIcon, columnsIcon, columnFreezeIcon, maxWidthIcon, displayInlineFlexIcon } from '@progress/kendo-svg-icons';
  ...
  return <TabStrip selected={selected} onSelect={handleSelect} animation={false}>
            ...
            <TabStripTab title={<TabStripTabTitle title="General" iconName="sliders" svgIcon={slidersIcon} />}>
                ...
                <GridColumnMenuItemGroup>
                    <GridColumnMenuItem title="Lock column" svgIcon={columnFreezeIcon} iconClass={'k-i-column-freeze'} onClick={onColumnLock} selected={props.column.locked} />
                </GridColumnMenuItemGroup>
                <GridColumnMenuItemGroup>
                    <GridColumnMenuItem title="Autosize This Column" svgIcon={maxWidthIcon} iconClass={'k-i-max-width'} onClick={onColumnAutoSize} />
                    <GridColumnMenuItem title="Autosize All Columns" svgIcon={displayInlineFlexIcon} iconClass={'k-i-display-inline-flex'} onClick={onAutoSizeAll} />
                </GridColumnMenuItemGroup>
            </TabStripTab>
            <TabStripTab title={<TabStripTabTitle title="Columns" iconName="columns" svgIcon={columnsIcon} />}>
                <GridColumnMenuColumnsList columnsState={columnsState} columns={columns} onColumnsChange={onColumnsChange} onCloseMenu={onCloseMenu} />
            </TabStripTab>
        </TabStrip>;
};